...
const Navbar = ({theme}) => {
  ...
  {loading?<div className='loading' id={`${!theme?"WHITE":""}`}>
    {!theme?<img src="https://github.com/gaumrab/reach/blob/main/src/assets/one.png" alt="Image" />:<img src="https://github.com/gaumrab/reach/blob/main/src/assets/one.png" alt="Image" />}
    </div>
    :
